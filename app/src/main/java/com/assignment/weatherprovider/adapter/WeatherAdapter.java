package com.assignment.weatherprovider.adapter;
...
import com.assignment.weatherprovider.utils.Util;

import java.util.Calendar;
import java.util.List;
import java.util.Locale;

public class WeatherAdapter extends RecyclerView.Adapter<WeatherAdapter.DayViewHolder> {
